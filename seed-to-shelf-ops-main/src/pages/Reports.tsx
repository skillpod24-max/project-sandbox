...
// monthlyData[month].revenue += Number(s.total_amount);
// }
// });
...
<Card className="border border-border">
  <CardContent className="p-4 text-center">
    <div className="h-10 w-10 rounded-full bg-chart-4/20 flex items-center justify-center mx-auto mb-2">
...
<p className="text-3xl font-bold text-chart-4">{summary.totalCustomers}</p>
<p className="text-sm text-muted-foreground">Total Customers</p>
</CardContent>
</Card>
<Card className="border border-border">
<CardContent className="p-4 text-center">
<div className="h-10 w-10 rounded-full bg-chart-3/20 flex items-center justify-center mx-auto mb-2">
<Wallet className="h-5 w-5 text-chart-3" />
</div>
<p className="text-3xl font-bold text-chart-3">₹{formatIndianNumber(summary.pendingAmount)}</p>
<p className="text-sm text-muted-foreground">Pending Amount</p>
</CardContent>
</Card>
<Card className="border border-border">
<CardContent className="p-4 text-center">
<div className="h-10 w-10 rounded-full bg-chart-2/20 flex items-center justify-center mx-auto mb-2">
<CreditCard className="h-5 w-5 text-chart-2" />
</div>
<p className="text-3xl font-bold text-chart-2">₹{formatIndianNumber(summary.collectedAmount)}</p>
...
<Card className="border border-border">
  <CardContent className="p-4 text-center">
    <div className="h-10 w-10 rounded-full bg-chart-5/20 flex items-center justify-center mx-auto mb-2">
...
>
{vehicleStatusData.map((_, i) => <Cell key={i} fill={COLORS[(i + 1) % COLORS.length]} />)}
</Pie>
<Tooltip
contentStyle={{
backgroundColor: 'hsl(var(--card))',
