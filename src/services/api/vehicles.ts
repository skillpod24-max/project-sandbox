...
export function useVehiclesPageData() {
  ...
  return useQuery({
    queryKey: ['vehicles-page', userId],
    queryFn: () => fetchVehiclePageData(userId!),
    enabled: !!userId,
  });
}
