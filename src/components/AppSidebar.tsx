...
export function AppSidebar() {
  ...
  return (
    <Sidebar collapsible="icon" className="will-change-transform border-r border-border/30 overflow-x-hidden opacity-0 hover:opacity-100 transition-opacity duration-300">
