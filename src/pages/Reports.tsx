...
supabase.from("payments").select("id,amount,payment_type,payment_date,payment_mode,customer_id,vendor_id,reference_id,principal_amount,interest_amount,profit_amount").eq("user_id", user.id),
supabase.from("emi_schedules").select("id,emi_number,emi_amount,amount_paid,status,due_date,sale_id,principal_component,interest_component,principal_paid,interest_paid").eq("user_id", user.id),
